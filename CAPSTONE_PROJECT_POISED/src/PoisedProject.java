...
public class PoisedProject{
	...
	// People
	PoisedPerson architect;
	PoisedPerson customer;
	PoisedPerson contractor;
	 ...
	 * @param finalised
	 */
	public PoisedProject(String projName, String projNum, String buildingType, String buildAddress,
				String erfNum, String deadline, double totalFee, double totalPaidDate,PoisedPerson architect,
				PoisedPerson customer, PoisedPerson contractor, String finalised) {
